...
- [x] Set up [UptimeRobot](https://uptimerobot.com) — free HTTP monitor pinging the app every 5 min to prevent cold starts (1-3 min load time on Streamlit free tier)
